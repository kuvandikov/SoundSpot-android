...
class PlaybackViewModelTest : BaseTest() {
    ...
    fun `onTitleClick navigates to search albums route`() = runTest {
        ...
        navigator.assertNextRouteContains(LeafScreen.Search().rootRoute, SoundspotSearchParams.BackendType.ALBUMS.type)
    }
    ...
    fun `onArtistClick navigates to search albums & artists route`() = runTest {
        ...
        navigator.assertNextRouteContains(
            ...
            SoundspotSearchParams.BackendType.ALBUMS.type,
            SoundspotSearchParams.BackendType.ARTISTS.type
        )
    }
}
